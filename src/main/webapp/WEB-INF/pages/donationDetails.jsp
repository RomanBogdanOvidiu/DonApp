...
<body id="page-top" class="index">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="intro-text">
						<span class="name">${(donation.donationsTitle)}</span>
						<hr class="star-light">
						<span class="skills">For donation</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2>Here are some pictures of ${(donation.donationsTitle)}</h2>
	...
	<section id="contact">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2>If you want this item Contact Me</h2>
					<hr class="star-primary">
				</div>
			</div>
			<div class="row">
